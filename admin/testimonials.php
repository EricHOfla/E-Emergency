...
$msg="Feedback Status: Deactivated";
}
...
$msg="Feedback Status: Publicly Visible";
}
...
<head>
	...
	<title>Aarogya Admin | Patient Feedback</title>
			...
			<div class="container-fluid">
				...
				<div class="row">
					<div class="col-md-12">
						...
						<h2 class="page-title">Patient Feedback Management</h2>

						<!-- Zero Configuration Table -->
						<div class="panel panel-default">
							<div class="panel-heading">Regional Testimonials</div>
...
{
	?><a href="testimonials.php?aeid=<?php echo htmlentities($result->id);?>" onclick="return confirm('Authorize this testimonial for public display?')" class="btn btn-sm btn-info"> Approve</a>
<?php } else {?>

<a href="testimonials.php?eid=<?php echo htmlentities($result->id);?>" onclick="return confirm('Hide this testimonial from public portal?')" class="btn btn-sm btn-warning"> Moderate</a>
<?php } ?></td>
										</tr>
										<?php $cnt=$cnt+1; }} ?>
