...
$query->execute();
$msg="Mission hotline and dispatch address updated";
}
?>
...
<head>
	...
	<title>Aarogya Admin | Hotline Settings</title>
			...
			<div class="container-fluid">
				...
				<div class="row">
					<div class="col-md-12">
						...
						<h2 class="page-title">Operational Hotline Configuration</h2>

						<div class="row">
							<div class="col-md-10">
								<div class="panel panel-default">
									<div class="panel-heading">Global Contact Registries</div>
...
<?php }} ?>
											...
											<div class="form-group">
												<div class="col-sm-8 col-sm-offset-4">
													...
													<button class="btn btn-primary" name="submit" type="submit">Deploy Changes</button>
												</div>
											</div>
