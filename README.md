...
```php
$db = new PDO('mysql:host=localhost;dbname=ambulance_booking', 'root', 'password');
```

### Step 4: Create Admin User
Run the registration form or execute:
```sql
INSERT INTO tbluser (username, email, password, status) 
VALUES ('admin', 'admin@example.com', PASSWORD('admin123'), 1);
```
...
├── my-booking.php           # User booking dashboard
├── my-testimonials.php      # User testimonials
├── car-listing.php          # Ambulance listing
├── contact-us.php           # Contact page
├── page.php                 # Dynamic pages (About, FAQs, etc)
├── index.php                # Homepage
├── README.md                # This file
├── LICENSE                  # MIT License
